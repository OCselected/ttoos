...
### `tabbit` 浏览器事件与“改头换脸”的内部共识：L1 文化对 L2 契约的系统性碾压

这种对物理效率的极致追求，深刻塑造了组织的 L1（底层文化与非正式制度）。在残酷的补贴大战中存活下来的组织，其基因里烙印着强烈的“丛林法则”与“唯快不破”的生存哲学。在这种文化底色中，“结果导向”压倒了一切长期主义的制度建设。

近期曝出的 `tabbit` 浏览器违规使用无许可（Unlicensed）开源仓库事件[10]，正是这种 L1 文化向上碾压 L2 制度的必然产物。**据近期媒体对美团内部 AI 化转型的深度报道披露 [16]，在内部极致的效率考核下，确有业务单元为了尽快拿到结果，不惜将开源社区上的产品“改头换脸”直接拿来使用。**
...
### 全面 AI 化的幻觉：从“物理榨汁机”到“代码榨汁机”

更令人感到撕裂的是其应对创新焦虑的方式。面对 2025 年激烈的本地生活战火与 160 亿的经营亏损，美团给出的解药是“全面 AI 化”。2025 年其研发投入高达 260 亿元，内部推出了名为 CatPaw 的 AI 编程工具，要求代码 AI 生成率逼近 60%，甚至让“Tab键”成为了工程师敲击频率最高的按键。

从社会黑客（Social Hacker）审视协作系统的视角来看，这场轰轰烈烈的内部基因突变，依然是一场巨大的幻觉。

美团高层明确表示“不追求成为词元（Token）工厂”，这实际上是主动宣告了其放弃在创新公地（如基础大模型开源生态）中建立属于自己的数字基础设施。它的百亿 AI 投资，无论是软件层面的代码生成，还是硬件层面的无人机，其终极目标依然极其单一且功利——这不过是将其在物理世界用来压榨骑手的“算法榨汁机”，平移到了数字世界，变成了一台对准程序员和业务流程的“代码榨汁机”。

一家试图用最高精尖的 AGI 技术来重塑自身的企业，其内部维持运转的底层治理机制（L3），竟然依然是机械僵化的“末位淘汰制”。这意味着无论它采购多少算力、接入多少种大模型，其组织的运转依然是靠人为的恐惧与内卷来驱动，而非靠开源社区那种平权、透明与热爱来激发。

这就是纯粹掠夺者的终局命运： 无论它搭便车拿来多么先进的大模型进行魔改，无论其内部的 Tab 键被敲击得多么飞快，当它拒绝在数字创新公地上建立公共契约与信任网络时，它的所有尖端技术只能被迫向内收敛。它注定只能扮演一个疲于奔命的“超级包工头”，在物理泥潭中无休止地压榨线下劳动力、商户以及内部员工，直至这台机器的最后一丝红利被彻底榨干。
...
15. Bourdieu, Pierre. 1986. “The Forms of Capital.” Pp. 241-258 in Handbook of Theory and Research for the Sociology of Education, edited by J. G. Richardson. New York: Greenwood Press.
16. 美团的真正威胁藏在暗处 ，https://mp.weixin.qq.com/s/wUzVqnj87r_TcjRdViBmxg （微信公众号）

## 关于作者

### 「开源之道」·适兕

![](/public/kuosi-face-of-os.png)「发现开源三部曲」（[《开源之迷》](posts/book-of-open-source/the-fascinating-of-open-source/)，《开源之道》《开源之思》。）、[《开源之史》](posts/history-of-open-source/summary/)作者，「开源之道：致力于开源相关思想、知识和价值的探究」主创，Social Hacker,协作机制设计师。
