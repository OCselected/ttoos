...
还有一个非常棒的有关开源战略的在线资源：一个叫做 [Changelog](https://changelog.com/)的博客，其还包含了一个涵盖不同开源话题的播客，叫做：[ “Request for Commits.” ](https://changelog.com/rfc)，该播客解决了从创建开源软件的人性方面到有关商业模式和策略的问题的所有内容。
