...
![](/images/2026/06/open-source-0.png)
...
Docker Swarm 的背后是 Docker 公司极其强烈的单方商业意志，其他巨头一旦加入，随时面临被 Docker 公司“敲竹杠”、更改技术路线乃至变相闭源的风险；而 CNCF 则通过极其复杂的、基于多方制衡的技术指导委员会（TOC）和席位投票规则，彻底排除了单一寡头垄断的可能。
